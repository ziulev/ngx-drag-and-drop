...
```
|__bundles/
   |__ngx-drag-and-drop.umd.js
   |__ngx-drag-and-drop.umd.js.map
   |__ngx-drag-and-drop.umd.min.js
   |__ngx-drag-and-drop.bundle.min.js.map
|__index.d.ts
|__package.json
|__README.md
|__*.d.ts
|__ngx-drag-and-drop.d.ts
|__ngx-drag-and-drop.module.d.ts
|__ngx-drag-and-drop.es5.js
|__ngx-drag-and-drop.es5.js.map
|__ngx-drag-and-drop.js
|__ngx-drag-and-drop.js.map
|__ngx-drag-and-drop.metadata.json
```
